...
<body class="" style="background: #e2e2e2;">
	...
	<%-- <img src="<c:url value="/resources/image/profile.jpg" />" alt="My Image"> --%>
	<h2 class="text-center m-4">This is my Home page</h2>
	<div class="container">
		<div class="card mx-auto mt-5 bg-primary" style="width: 80%">
			<div class="card-body py-5">
				<h3 class="text-center text-white text-uppercase">My Search
					Application</h3>
